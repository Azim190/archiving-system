    ...
    return (
        <>
            <aside className={clsx(
                "fixed inset-y-0 start-0 z-50 w-64 bg-white border-r border-slate-200 flex flex-col transition-transform duration-300 ease-in-out md:sticky md:top-0 md:h-screen md:!translate-x-0 rtl:border-r-0 rtl:border-l",
